//------------------------------------------------------------------------------
//
// File Name:	ImGuiWindowProperties.h
...
namespace Nightjar
{
    ...
    // Class Definition:
    class ImGuiWindowProperties : public ImGuiWindowBase
    {
    ...
    public:
        ImGuiWindowProperties(void);

        ImGuiWindowProperties(const ImGuiWindowProperties& other) = delete;

        ImGuiWindowProperties(ImGuiWindowProperties&& other) noexcept;

        ImGuiWindowProperties& operator=(const ImGuiWindowProperties& other) = delete;
