//------------------------------------------------------------------------------
//
// File Name:	TemplateImGuiWindow.h
// Author(s):	
// Course:		GAM200F25
...
namespace Nightjar
{
    ...
    // Class Definition:
    class TemplateImGuiWindow : public ImGuiWindowBase
    {
    ...
    public:
        TemplateImGuiWindow(void);

        TemplateImGuiWindow(const TemplateImGuiWindow& other) = delete;

        TemplateImGuiWindow(TemplateImGuiWindow&& other) noexcept;

        TemplateImGuiWindow& operator=(const TemplateImGuiWindow& other) = delete;
    ...
    private:
        ...
        bool ReadKeyValue(string_view_arg key, string_view_arg value) override;
