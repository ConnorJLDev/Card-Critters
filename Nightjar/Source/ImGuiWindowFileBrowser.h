//------------------------------------------------------------------------------
//
// File Name:	ImGuiWindowFileBrowser.h
...
namespace Nightjar
{
    ...
    // Class Definition:
    class ImGuiWindowFileBrowser : public ImGuiWindowBase
    {
    ...
    public:
        ImGuiWindowFileBrowser(void);

        ImGuiWindowFileBrowser(const ImGuiWindowFileBrowser& other) = delete;

        ImGuiWindowFileBrowser(ImGuiWindowFileBrowser&& other) noexcept;

        ImGuiWindowFileBrowser& operator=(const ImGuiWindowFileBrowser& other) = delete;
    ...
    private:
        ...
        vector_t<string_t> files_;
        string_t startPath_;
        string_t selectedFile_;
        bool initialized_;
        bool refresh_;
    };
