...
namespace Nightjar
{
    ...
    // Class Definition:
    class ImGuiWindowAudio : public ImGuiWindowBase
    {
    ...
    public:
        ImGuiWindowAudio(void);

        ImGuiWindowAudio(const ImGuiWindowAudio& other) = delete;

        ImGuiWindowAudio(ImGuiWindowAudio&& other) noexcept;

        ImGuiWindowAudio& operator=(const ImGuiWindowAudio& other) = delete;
